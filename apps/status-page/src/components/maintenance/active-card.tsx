...
export function ActiveMaintenanceCard({
  maintenance,
  monitorNames,
  nowMs,
}: ActiveMaintenanceCardProps) {
  ...
  return (
    <Card className={cn('p-3 border', colors.bg, colors.border)}>
      <div className="flex items-start gap-3">
        <IconAlertTriangle className={cn('h-5 w-5 mt-0.5 shrink-0', colors.icon)} />
